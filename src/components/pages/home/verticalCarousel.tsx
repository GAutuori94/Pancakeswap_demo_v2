      ...
      <div className="vertical_carousel w-50 ml-10">
        <div className="carousel_container__vertical_carousel mt-[24px]">
          <div className="top__carousel_container__vertical_carousel mb-[24px] flex items-center">
            <h2 className="text-lightText font-['Kanit'] leading-lineHeightPar font-fontSizeParagraph font-fontHeavyWeight flex gap-0.5">
              Top
            ...
            <button>
              <svg
                ...
                className="invert_button fill-lightTextSubtle"
              >
          ...
          <div className="bottom__carousel_container__vertical_carousel">
            <div className="gridView__bottom__carousel_container grid grid-cols-5 gap-[32px]">
              <div className="column__gridView border-0 ">
                <div className="data__column__gridView pl-0 pr-[16px] border-none !important">
                  <div className="market__data__column">BUSD-ETH</div>
                  <div className="percent__data__column">
                    <span>1234.76%</span>
                    </div>
                  <div className="apy__data__column">APR</div>
                </div>
              </div>
              <div className="column__gridView">
                <div className="data__column__gridView">
                  <div className="market__data__column">BUSD-ETH</div>
                  <div className="percent__container__data__column">
                    <div className="percent__data__column">
                        <span>1234.76%</span>
                        </div>
                  </div>
