...
const Nav: React.FC = () => {
  ...
  return (
    <nav className='navbar flex justify-between items-center w-full h-14 bg-lightBackgroundAlt dark:bg-darkBackgroundAlt border-b-1 border-b-lightCardBorder dark:border-b-darkCardBorder px-4 z-20'>
      <SettingsModal
      ...
      <div className='interactionsContainer  flex items-center h-full '>
        <div className='flex justify-between'> 
          ...
          <div className='flex '>
            ...
            <div className='flex '  >
              <p className='priceValueContainer ml-3 hidden xl:flex dark:text-darkTextSubtle'>{`$${priceValue}`}</p>
            </div>
          </div>
            ...
            <div className='flex '>
              ...
              <button className='transparent '>
                <svg
                  ...
                  className='fill-lightTextSubtle dark:fill-darkTextSubtle hidden md:flex xl:flex'
                >
