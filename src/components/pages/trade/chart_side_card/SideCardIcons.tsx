...
export function NoGraphIcon() {
  return (
    <svg
      ...
      className="h-5 self-center fill-lightTextSubtle dark:fill-darkTextSubtle shrink-0 filter-none"
    >
      <path
        d="M21.5 1l-20 20"
        strokeWidth="2"
...
export function SettingsIcon() {
  return (
    <svg
      ...
      color="textSubtle"
      xmlns="http://www.w3.org/2000/svg"
      className="self-center fill-lightTextSubtle dark:text-darkTextSubtle shrink-0"
    >
