...
export function TickerContextProvider({ children }: { children: React.ReactNode }) {
    const {loading: dataFetchedLoading, error: dataFetchedError, data: dataFetched} = useFetchApi<TickerModel[]>('/api/v3/ticker/24hr?symbols=["ETHBTC","LTCBTC","BNBBTC","NEOBTC","QTUMETH","EOSETH","SNTETH","BNTETH","BCCBTC","GASBTC"]')
